module.exports = function(grunt){
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            cssConcat:{
                src:['src/css/base.css','src/css/frame.css'],
        ...
        less: {
          production: {
            ...
            files: {
                'src/css/frame.css' : 'less/frame.less'
            }
          }
        },   
        //压缩css
        ...
        watch:{
            build:{
                ...
                tasks:['less','jshint','csslint','concat','cssmin','uglify'],
                options:{spawn:false}
            }
        }
    ...
    grunt.registerInitTask('default',['jshint','less','csslint','concat','cssmin','uglify','watch']);//先进行语法检查，如果没有问题，再合并，再压缩
};